            ...
            keywords.forEach(keyword => {
              ...
              if (keyword['@id'].includes('p1808')) {
                ...
                this.http.get(id).subscribe(evt => {
                  ...
                  this.http.get(descid).subscribe(descevt => {
                      console.log(descevt['short_description'].en);
                      this.mediaService.setDesc(descevt['short_description'].en);
                  });
              }
            });
